...
import numpy as np
from ss_baselines.common.utils import observations_to_image, plot_top_down_map, resize_observation, linear_decay, generate_video
import torch
...
from sen_baselines.se_nav_5len.ppo.policy import SenBaselinePolicy

from tqdm import tqdm


@baseline_registry.register_trainer(name="SENDDPPOTrainer-5")
class DDPPOTrainer(PPOTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config, observation_space=None) -> None:
        ...
        self.actor_critic = SenBaselinePolicy(
