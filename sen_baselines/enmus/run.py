...
def main():
    ...
    parser.add_argument(
        ...
        type=bool,
        default=False,
        help="Whether to normalize the input first",
    )
    parser.add_argument(
        "--actor-critic-path",
        type=str,
    ...
    # run exp
    config = get_config(args.exp_config, args.opts, args.model_dir, args.run_type, args.overwrite, args.decoder_type, args.norm_first, args.actor_critic_path)
