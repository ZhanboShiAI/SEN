...
_TC.SIMULATOR.AUDIO.EVERLASTING = False
_TC.SIMULATOR.AUDIO.BINAURAL_RIR_DIR = "data/binaural_rirs"
# Add ambisonic data dir path
_TC.SIMULATOR.AUDIO.AMBISONIC_RIR_DIR = "data/ambisonic_rirs"
# Add audio simulation type
_TC.SIMULATOR.AUDIO.TYPE = "ambisonic"
...
_TC.SIMULATOR.AUDIO.HAS_NOISE = False
_TC.SIMULATOR.AUDIO.DISTRACTOR_SOUND_DIR = 'data/sounds/sound_event_splits/sound_event'
_TC.SIMULATOR.AUDIO.NOISE_SOUND_DIR = 'data/sounds/sound_event_splits/noise'
# -----------------------------------------------------------------------------
